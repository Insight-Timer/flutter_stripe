...
class _$CardStyleConstructorImpl extends _CardStyleConstructor {
  ...
  @override
  String toString() {
    return 'CardStyle(borderWidth: $borderWidth, backgroundColor: $backgroundColor, borderColor: $borderColor, borderRadius: $borderRadius, cursorColor: $cursorColor, textColor: $textColor, fontSize: $fontSize, fontFamily: $fontFamily, fontWeight: $fontWeight, textErrorColor: $textErrorColor, placeholderColor: $placeholderColor)';
  }
