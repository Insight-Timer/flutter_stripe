...
class _$MandateDataCustomerAcceptanceImpl
  ...
  const _$MandateDataCustomerAcceptanceImpl({this.ipAddress});

  factory _$MandateDataCustomerAcceptanceImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$MandateDataCustomerAcceptanceImplFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$MandateDataCustomerAcceptanceImplToJson(
      this,
    );
  }
}
...
abstract class _MandateDataCustomerAcceptance
  ...
  factory _MandateDataCustomerAcceptance.fromJson(Map<String, dynamic> json) =
      _$MandateDataCustomerAcceptanceImpl.fromJson;
