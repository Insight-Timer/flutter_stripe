...
_$MandateDataCustomerAcceptanceImpl
    _$$MandateDataCustomerAcceptanceImplFromJson(Map<String, dynamic> json) =>
        _$MandateDataCustomerAcceptanceImpl(
...
Map<String, dynamic> _$$MandateDataCustomerAcceptanceImplToJson(
        _$MandateDataCustomerAcceptanceImpl instance) =>
    <String, dynamic>{
